...
exports.toggleLikeReply = exports.toggleLikePost = void 0;
...
const toggleLikePost = async (req, res) => {
    ...
    try {
        const likedPost = await prisma_1.prisma.like.findUnique({
            where: {
                userId_postId: {
                    userId,
                    postId
...
const toggleLikeReply = async (req, res) => {
    ...
    try {
        const likedReply = await prisma_1.prisma.like.findUnique({
            where: {
                userId_replyId: {
                    userId,
                    replyId
        ...
        if (likedReply) {
            ...
            await prisma_1.prisma.notification.deleteMany({
                where: {
                    ...
                    type: client_1.NotificationType.LIKE_REPLY
                }
            });
